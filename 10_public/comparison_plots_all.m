...
% comparison_plots_all('intermediate_5_alpha09/','intermediate_5_alpha05/','intermediate_5_alpha01/','intermediate_5_alpha0001/','opt-all_','rand-all_','intermediate_5_alpha',{'00001','00005','0001','0005','001','005','01','02','03','04','05','06','07','08','09','095','099'},5)
%
...
print('-loose',fig1,['output/figures/','toy-model'],'-dpdf','-r0');
end